...
(function ($) {
  ...
  var clPreloader = function () {
    ...
    // Add a timeout to ensure the preloader is removed even if load event doesn't fire
    setTimeout(function () {
  ...
  var clMenuOnScrolldown = function () {
    ...
    $WIN.on("scroll", function () {
      ...
      // Check if we're over a white section by looking at sections with white background
      $("section").each(function () {
        var $section = $(this);
        var sectionTop = $section.offset().top;
        var sectionBottom = sectionTop + $section.height();

        if (st >= sectionTop - 100 && st <= sectionBottom - 100) {
          if ($section.css("background-color") === "rgb(255, 255, 255)") {
      ...
      // Add opaque class when scrolling down past threshold or over white sections
      if ((st > lastScrollTop && st > scrollThreshold) || isOverWhiteSection) {
