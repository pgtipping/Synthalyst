        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Prepare for your job interviews with AI-powered assistance
              tailored to your specific job application.
            </p>
            <div>
            ...
            <Card className="bg-green-50 border-green-200 mb-6">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-green-700">
                  Your job details have been imported from ApplyRight to help
                  ...
                  <div className="grid gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Provide information about the job you&apos;re applying
                        for
                      </p>
                    </div>
                    <div className="flex flex-col gap-2">
                      ...
                      <CardContent className="pt-6">
                        <div className="flex flex-col items-center text-center">
                          ...
                          <p className="text-sm text-muted-foreground mt-2">
                            Tailored interview questions and preparation based
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="flex flex-col items-center text-center">
                          ...
                          <p className="text-sm text-muted-foreground mt-2">
                            Practice with our AI interviewer and receive
            ...
            <TabsContent value="practice" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Practice with these tailored interview questions based on
                  ...
                  prepPlan.sections.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <p className="text-muted-foreground">
                        Please submit your job details first to generate
                        practice questions.
                      </p>
                      <Button
                        variant="outline"
            ...
            <TabsContent value="question-library" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Browse our comprehensive library of interview questions by
                ...
                <CardContent>
                  {checkPremiumStatus() ? (
                    ...
                    <div className="text-center py-8">
                      <p className="text-muted-foreground">
                        The question library is a premium feature. Please sign
                        in or upgrade to access.
                      </p>
                      <Button
                        variant="default"
                        onClick={handleSignIn}
