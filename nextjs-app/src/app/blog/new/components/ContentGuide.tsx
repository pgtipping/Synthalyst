            ...
            <div className="overflow-hidden">
              <Tabs defaultValue="voice">
                <div className="overflow-x-auto sm:overflow-visible">
                  <TabsList
                    className="w-full justify-start border-b px-6 flex-wrap overflow-x-auto sm:overflow-visible"
                    role="tablist"
                  >
                ...
                <div className="overflow-x-hidden">
                  <TabsContent value="voice" className="px-6 py-4">
                    <div className="break-words">
                      ...
                      <ul className="ml-4 list-disc space-y-2">
                        ...
                        <li>
                          <span className="font-medium">Approachable:</span>{" "}
                          Write like you&apos;re having a conversation with a
                          friend
                        </li>
                        <li>
                          <span className="font-medium">Practical:</span>{" "}
                          Include actionable advice readers can apply today
                        </li>
                        <li>
                          <span className="font-medium">Evidence-based:</span>{" "}
                          Back up claims with data or examples when possible
                        </li>
                        <li>
                          <span className="font-medium">Positive:</span> Focus
                          on solutions and opportunities, not just problems
                        </li>
                      </ul>
                    </div>
                  </TabsContent>

                  <TabsContent value="structure" className="px-6 py-4">
                    <div className="break-words">
                      <h3 className="mb-2 flex items-center font-semibold">
                        <Sparkles className="mr-2 h-4 w-4 text-primary" />
                      ...
                      <p className="mb-2 text-sm text-gray-600">
                        Your title is your first impression! Make it specific
                        and interesting.
                      </p>
                      <ul className="ml-4 list-disc space-y-1">
                        ...
                        <li>
                          <span className="italic">Example:</span> &quot;5 AI
                          Tools That Will Transform How You Work in 2025&quot;
                        </li>
                      </ul>
                  ...
                  <TabsContent value="categories" className="px-6 py-4">
                    <div className="break-words">
                      ...
                      <p className="mb-3 text-sm text-gray-600">
                        Choose one or more categories that best fit your
                        content. This helps readers find topics they&apos;re
                        interested in.
                      </p>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            ...
                            AI Developments, Tool reviews, Digital
                            transformation, Future trends
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            <span className="font-medium">Example topics:</span>{" "}
                            Career development, Skill-building strategies,
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            <span className="font-medium">Example topics:</span>{" "}
                            Training methodologies, Educational technology,
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Methods, systems, and tools to enhance personal and
                            team productivity.
                          </p>
                          <p className="mt-1 text-xs text-gray-500">
                            <span className="font-medium">Example topics:</span>{" "}
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            <span className="font-medium">Example topics:</span>{" "}
                            Market analysis, Case studies, Expert interviews,
                            Trend forecasts
                          </p>
                        </div>
                  ...
                  <TabsContent value="tips" className="px-6 py-4">
                    <div className="break-words">
                      <h3 className="mb-2 flex items-center font-semibold">
                      ...
                      <ul className="ml-4 list-disc space-y-2">
                        ...
                        <li>
                          <span className="font-medium">Add bullet points</span>{" "}
                          for lists (like this one!) to make information
                          scannable
                        </li>
                        <li>
                          <span className="font-medium">
                  ...
                  <TabsContent value="examples" className="px-6 py-4">
                    <div className="break-words">
                      <h3 className="mb-2 flex items-center font-semibold">
                        <Sparkles className="mr-2 h-4 w-4 text-primary" />
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="rounded-md border border-gray-200 p-3">
                          ...
                          <p className="text-sm italic">
                            &quot;Remember when creating a job description took
                            days of research and endless revisions? Those days
                            are officially over. With the rise of AI-powered
                            writing assistants, what once took days now takes
                            minutes—and the results are often better than what
                            human HR professionals could create alone. In this
                            post, I&apos;ll show you how these tools are
                            revolutionizing recruitment and how you can start
                            using them today.&quot;
                          </p>
                          <p className="mt-1 text-xs text-gray-500">
                            <span className="font-medium">Why it works:</span>{" "}
                            Relatable opening, clear problem/solution, preview
                            of value
                          </p>
                        </div>
                        ...
                        <div className="rounded-md border border-gray-200 p-3">
                          ...
                          <p className="text-sm italic">
                            &quot;As AI continues to evolve, the line between
                            human and machine-generated content will blur even
                            further. The winners won&apos;t be those who resist
                            this change, but those who learn to collaborate
                            effectively with AI tools. Start with the techniques
                            we&apos;ve covered today, and you&apos;ll be
                            well-positioned to ride this wave of innovation
                            rather than being swept away by it. What AI tool
                            will you try first?&quot;
                          </p>
                          <p className="mt-1 text-xs text-gray-500">
                            <span className="font-medium">Why it works:</span>{" "}
                            Forward-looking perspective, actionable takeaway,
                            ending question
                          </p>
                        </div>
                      </div>
